...
\let\oldvec\vec
\usepackage[bottom=0.7in, left=.5in, right=.7in, top=.7in]{geometry}
...
\underset{U\in \mathbb{R}^{n,d}}{\mathrm{argmin}}\, \sum_{i}^{m}\norm{\va{x}_i - UU^T\va{x}_i}^2_2 \quad \mathrm{subject\ to\ } U^TU=\mathbb{I}
	...
	\centering
		\begin{minipage}[t]{0.45\textwidth}
			...
			\captionof{figure}{Tree-based models F1 when applying undersampling}
			\label{fig:26}
		\end{minipage}
		\begin{minipage}{0.05\textwidth}
			\quad
	...
	\begin{figure}[!h]
		...
		\captionof{figure}{Decision Tree features importance}
		\label{fig:32}
	\end{figure}
	...
	\begin{figure}[!h]
		...
		\setlength{\abovecaptionskip}{-5pt}
		\captionof{figure}{Decision Tree With Pruning features importance}
		\label{fig:33}
	\end{figure}
	\begin{figure}[!h]
		\centering
		\begin{minipage}[t]{0.45\textwidth}
			\includegraphics[width=\textwidth]{images/models_f1_with_undersampling.png}
			\setlength{\abovecaptionskip}{-10pt}
			\captionof{figure}{F1 score of models for each dimensionality reduction technique when applying undersampling.}
			\label{fig:28}
		\end{minipage}
		\begin{minipage}{0.05\textwidth}
			\quad
		\end{minipage}
		\begin{minipage}[t]{0.45\textwidth}
			\includegraphics[width=\textwidth]{images/models_f1_with_oversampling.png}
			\setlength{\abovecaptionskip}{-10pt}
			\captionof{figure}{F1 score of models for each dimensionality reduction technique when applying oversampling.}
			\label{fig:29}
		\end{minipage}
		\begin{minipage}[t]{0.45\textwidth}
			\includegraphics[width=\textwidth]{images/models_accuracy_with_undersampling.png}
			\setlength{\abovecaptionskip}{-10pt}
			\captionof{figure}{Accuracy of models for each dimensionality reduction technique when applying undersampling.}
			\label{fig:30}
		\end{minipage}
		\begin{minipage}{0.05\textwidth}
			\quad
		...
		\begin{minipage}[t]{0.45\textwidth}
			...
			\setlength{\abovecaptionskip}{-10pt}
			\captionof{figure}{Accuracy of models for each dimensionality reduction technique when applying ovresampling.}
			\label{fig:31}
		\end{minipage}
	\end{figure}
